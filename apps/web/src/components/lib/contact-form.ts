...
export type ContactCheckboxGroupField = BaseContactField & {
  type: 'checkbox-group';
  options: string[];
};

export type ContactField = ContactInputField | ContactSelectField | ContactTextareaField | ContactCheckboxGroupField;
